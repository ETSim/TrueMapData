...
class CompressionStrategyFactory:
    ...
    def get_strategy(cls, format_type: str, **kwargs) -> CompressionStrategy:
        ...
        if not strategy_class:
            ...
            raise ValueError(
                f"Unsupported compression format '{format_type}'. " f"Supported formats: {supported}"
            )
...
def compress_sequence(
    sequence_data: Dict[str, Any], output_path: str, format_type: str = "npz", **kwargs
) -> str:
    """
...
def decompress_sequence(input_path: str, format_type: Optional[str] = None, **kwargs) -> Dict[str, Any]:
    """
